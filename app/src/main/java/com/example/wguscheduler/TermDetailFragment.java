...
import com.example.wguscheduler.dummy.DummyContent;

/**
 * A fragment representing a single Term detail screen.
...
public class TermDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.term_detail)).setText(mItem.details);
        }
